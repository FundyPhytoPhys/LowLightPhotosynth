...
In parallel with seasonally low light, psychrophile phytoplankton contend with cold temperature constraints on water viscosity, solute diffusion rates, membrane fluidity, enzyme kinetics and macromolecule interactions [@lyonPolarMicroalgaeNew2014]. Additionally, salinities vary across polar habitats  [@morgan-kissPhotoadaptationPolarNight2016, @smootDepthstratifiedCommunityStructure2017], and can fluctuate annually,  driven by freezing and thawing of ice [@cartonSeasonalCycleArctic2015].
...
# Chlamy_aovfullinteract <- readRDS(file = file.path("Data", "ProcessedData", "Chlamy_aovfullinteract.Rds"))
# 
# knitr::kable(Chlamy_aovfullinteract,
#   caption = "Analyses of Variation of damping indices testing effects of *Chlamydomonas* taxa, effective equivalent light level (µmol photons m^-2^s^-1^, estimated from flash spacings in seconds and 𝛔~PSII~), measurement temperature, and the growth concentration of NaCl, with interactions among all factors.")
