...
ChlamyCultures <- OttawaMetadata |>
  ...
  rename(Taxa = Strain,
         GrowthPAR = Par_ue) |>
  summarize(.by = c(Taxa, Lineage, GrowthPAR, Photoperiod, GrowthTemp_C, Habitat, NaCl_mM, NaCl_opt, Media))
...
SackvilleHabitat <- c(rep("Temperate", 3))
...
SackvilleCultures <- tibble(SackvilleTaxa, SackvilleLineage, SackvilleHabitat, SackvilleGrowthTemp_C, SackvilleGrowthPAR, SackvillePhotoperiod, SackvilleMedia) |>
  rename_with(~str_remove(., "Sackville")) |>
  mutate(NaCl_mM = 500, 500, 0.43, 
         NaCl_opt = 500, 0.43, 0.43) |> 
  summarize(.by = c(Taxa, Lineage, GrowthPAR, Photoperiod, GrowthTemp_C, Habitat, NaCl_mM, NaCl_opt, Media))

Cultures <- rbind(ChlamyCultures, TakuvikCultures, SackvilleCultures)  |>
  mutate(Taxa = str_replace_all(Taxa, "_", " ")) |>
  arrange(Lineage, Habitat, Taxa, NaCl_mM)
