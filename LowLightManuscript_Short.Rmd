...
Lineage <- c(rep("Diatom", 2), rep("Green", 3), rep("Diatom", 2), rep("Green", 3))
...
TaxaCultures <- tibble(Taxa, Lineage, Origin, Growth_C, Growth_PAR, Growth_Photoperiod, Media)
                            
 if (knitr::is_html_output()) { 
  knitr::kable(TaxaCultures,
    caption ="Study taxa and culture growth conditions.",
    col.names = c("Taxa", "Lineage", "Origin", "Growth °C", "PAR (µE)", "Photoperiod (h)", "Media")
    ) |>
...
$$
XXXArthur: 1/σPSII is used to convert the probability that an incident photon is absorbed by PSII into a photon flux density required to trigger a photochemical event, i.e. to estimate effective light availability per PSII.XXX
...
Equiv_Light <- c(" 0.53428 - 0.02428", "0.89781 - 0.05102", "0.84377 -0.04670", "0.65678 - 0.02981", "0.77084 - 0.04289", "0.73733 - 0.04252", "0.65817 - 0.03705")
...
XXX Arthur: If you redo the GAM figures. I think it would be wise to keep the same colorimetric scale of the Dampng indexes to compare the two lines more easily.
The same goes for the y scales, which don't seem to be quite the same.XXX
