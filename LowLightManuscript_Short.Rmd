...
```{r gammodeltemp}
# TaxaGAM <- c("Thalassiosira pseudonana", "Chlorella vulgaris",  "Chlamydomonas reinhardtii",  "Fragilariopsis cylindrus growth @ O°C", "Fragilariopsis cylindrus growth @ 6°C", "Chlamydomonas priscui", "Chlamydomonas sp. ICE-MDV", "Chlamydomonas malina")
# 
# EDF <-
# F_ratio <-
# P_value <- 
