...
```{r fluormeas}
TaxaFluor <- c("Thalassiosira pseudonana", "Chlorella vulgaris",  "Chlamydomonas reinhardtii", "Chlamydomonas euryale",  "Fragilariopsis cylindrus",  "Chlamydomonas priscui",  "Chlamydomona malina", "Chlamydomonas sp. ICE-MDV",)

Flash_Spacings <- c(rep("1, 2, 4, 8, 16",7))
Equiv_Light <- c(" 0.53428 - 0.02428", "0.89781 - 0.05102", "0.84377 -0.04670", "XXXX-YYYY", "0.65678 - 0.02981", "0.77084 - 0.04289", "0.65817 - 0.03705", "0.73733 - 0.04252")
Meas_Temp <- c("10, 14, 18, 20, 22, 24, 28", "10, 14, 18, 22, 26", "12, 16, 20, 24, 28", "16, 20, 24, 28", "0, 2, 6, 10",  "2, 4, 8, 12, 16",rep("2, 4, 8, 12", 2))
