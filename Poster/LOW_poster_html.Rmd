...
```
## Natasha Ryan, Maximilian Berthold, Douglas A. Campbell

Mount Allison University Biology

# Background
The accepted lower limit of the photic zone: 1% of surface irradiance, equivalent to 1 photon reaching a PSII every ~0.03 seconds @ravenPutOutLight2000. Some arctic diatoms achieve net C uptake with 1 photon only reaching a PSII every 0.6-60 seconds @randelhoff2020.           
...
Derive the maximum quantum yield of PSII (F~V~/F~M~ = F~M~-F~0~/F~M~) for each sequential flash
