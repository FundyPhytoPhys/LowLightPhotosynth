...
subtitle: Effects of Temperature and Frequency of Photon Delivery on Wasteful Slippage of the S-State Cycle in Photosystem II
author:
  - name: Effects of Temperature and Frequency of Photon Delivery on Wasteful Slippage of the S-State Cycle in Photosystem II
    affil: 1, 2
affiliation:
  - num: 1
    address: Natasha Ryan
  - num: 2
...
# Background
The accepted lower limit of the photic zone is 1% of surface irradiance, equivalent to 1 photon reaching a PSII every ~0.03 seconds @ravenPutOutLight2000.        
However, some arctic diatoms may achieve net C uptake when 1 photon only reaches a PSII every 0.6-60 seconds @randelhoff2020.        
