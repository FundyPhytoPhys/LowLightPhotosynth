...
```{r greensgamtemp, fig.cap = "Generalized Additive Models (GAM) for polar and temperate green algae, of consecutive flashes before damping of SState induced oscillations in maximum quantum yield of photosystem II (F~V~F~M~). GAM predicted by the measurement temperature (°C) and the effective light level (µmol photons m^-2^s^-1^, estimated from flash spacings (s) and effective absorption cross-section of photosystem II, σ~PSII~, (A^2^)). Dashed vertical lines represent the growth temperatures. Measurement temperatures varied across taxa but the temperature axis scalings are comparable across plots. Data for GAM was taken from cultures grown and measured near their respective optimal salinities.", out.height = "100%", out.width = "100%", align = 'c', echo = FALSE}
