...
if (knitr::is_html_output()) {
  kable(FluorMeas,
        caption ="Single turnover saturating flash measurement conditions, with key growth conditions, equivalent effective light levels (µmol photons m^-2^s^-1^), mean σ~PSII~ (A^2^) and mean F~V~F~M~ for each measurement",         
