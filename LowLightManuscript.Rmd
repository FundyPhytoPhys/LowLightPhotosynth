...
Then, a 3 mL sample of culture was loaded into a temperature-controlled water-jacketed cuvette (PolyScience) placed within the measurement chamber of a Soliense fluorometer (Version LIFT-REM 1.0, Soliense Inc). The apparatus was covered to block out incident light and cells were acclimated to the dark for a minimum of 30 seconds. In the dark PSII reaction centres relax to ground state, open for photochemistry upon receipt of an absorbed photon. [@schubackSingleTurnoverVariableChlorophyll2021]. In parallel the oxygen evolving complex (OEC) relaxes primarily to S1 [@hanDirectQuantificationFour2008], so S-States of the population of PSII are largely synchronized.
