...
### Normalize Fluorescence & Add Light Level and Temperature Differential Columns 
...
SolFitsTrim2 <- conversion(SolFitsTrim2) # add column for light level (µmol photons/m2/s)
```
