...
Other adjustments: 
  ...
  20230918_MaPo1002_4C_16s        - remove, incorrect spacing
  20230919_MaPo1002_12C_8s        - remove, incorrect spacing
  20230920_MaPo1005_12C_16s       - remove, incorrect spacing 
  20230920_MaPo1005_24C_16s       - remove, incorrect spacing 
  20230918_MaPo1001_12C_16s       - triple, contains 3 runs, 1-32 = 8s, 33-64 = 2s, and 65-96 = 16s

```{r manually trim data}
last32 <- SolFitsTrim %>%
  filter(!Filename %in% c("20230918_MaPo1002_4C_16s","20230918_MaPo1001_4C_1s", "20230919_MaPo1002_12C_8s", "20230920_MaPo1005_12C_16s", "20230920_MaPo1005_24C_16s", " 20230918_MaPo1001_12C_16s")) %>%
  group_by(Filename) %>%
...
SolFitsTrim2 <- rbind(last32, MaPo1001_4C_1s)
```
