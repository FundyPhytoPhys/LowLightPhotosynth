...
```{r Plot Setup}
strain.labs <- c(
  "Fragilariopsis_cylindrus" = "Fragilariopsis cylindrus",
...
algae.vlines <- data.frame(
  ...
  GrowthTemp_C = c(4.1, 4.1, 4.1, 22, 23.9), 
...
# ggsave("diatoms_diff.png", width = 6 , height = 5, dpi = 900,
#        plot=last_plot(),
#        path="../Output")
```
...
# ggsave("algae_diff.png", width = 7 , height = 7, dpi = 900,
#        plot=last_plot(),
#        path="../Output")
```
...
predict.temp %>%
  ...
  scale_y_continuous(expand=c(0,0)) +
  ggh4x::facet_nested_wrap(vars(Strain, GrowthTemp_C), ncol = 3, 
...
# ggsave("diatoms_temp.png", width = 9.5 , height = 4.5, dpi = 900,
#        plot=last_plot(),
#        path="../Output")
```
