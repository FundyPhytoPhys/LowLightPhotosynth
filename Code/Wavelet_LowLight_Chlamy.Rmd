...
Chlamy_data <- summaryBy(FvFmrunnorm ~ Strain + PulseSpace_s + Temp_C + TempDiff_C +  Flashnumber + LightLevel_ue + NaCl_mM + NaCl_opt + GrowthTemp_C, data=SolFitsChlamyMeta, FUN=mean, keep.names = TRUE) %>%
  splitBy(formula = ~ Strain + PulseSpace_s + Temp_C + TempDiff_C + LightLevel_ue + NaCl_mM + NaCl_opt + GrowthTemp_C)
...
Chlamy_damping <- damping(Chlamy_reconstruction)  %>%
  ...
  separate(condition, into=c("Strain", "PulseSpace_s", "Temp_C", "TempDiff_C", "LightLevel_ue", "NaCl_mM", "NaCl_opt", "GrowthTemp_C"), sep = "\\|") |>
