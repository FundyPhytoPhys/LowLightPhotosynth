...
Cm_damping <- Cm_damping %>%
  mutate(DampingIndex = ifelse(Light_Level == 0.07333, 0, DampingIndex)) #remove outlier 

#regenerate model
malina.test <- mgcv::gam(DampingIndex ~ te(TempDiff_C, Light_Level, k=3), data = Cm_damping, method = "REML") 
