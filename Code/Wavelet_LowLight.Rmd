...
saveRDS(sstate_damping, file.path(DataOut, paste(Project, "SState_Damping(Diff.RDS", sep = "_"), fsep = .Platform$file.sep))
```

# Saving Wavelets for Results Section
```{r}
# saveRDS(Fc_wavelets, file.path(DataOut, paste(Project, "FcWavelets.RDS", sep = "_"), fsep = .Platform$file.sep))
# 
# saveRDS(Ci_wavelets, file.path(DataOut, paste(Project, "CiWavelets.RDS", sep = "_"), fsep = .Platform$file.sep))
# 
# saveRDS(Cm_wavelets, file.path(DataOut, paste(Project, "CmWavelets.RDS", sep = "_"), fsep = .Platform$file.sep))
# 
# saveRDS(Cp_wavelets, file.path(DataOut, paste(Project, "CpWavelets.RDS", sep = "_"), fsep = .Platform$file.sep))
# 
# saveRDS(Cr_wavelets, file.path(DataOut, paste(Project, "CrWavelets.RDS", sep = "_"), fsep = .Platform$file.sep))
# 
# saveRDS(Cv_wavelets, file.path(DataOut, paste(Project, "CvWavelets.RDS", sep = "_"), fsep = .Platform$file.sep))
# 
# saveRDS(Tp_wavelets, file.path(DataOut, paste(Project, "TpWavelets.RDS", sep = "_"), fsep = .Platform$file.sep))
```
...
#c("-12","-8","-4","0","2","4","6","8","10"))

sstate_damping$Species <- factor(sstate_damping$Species, levels= c("Chlamydomonas_ICEMDV", "Chlamydomonas_malina", "Chlamydomonas_priscuii", "Fragilariopsis_cylindrus", "Chlamydomonas_reinhardtii", "Chlorella_vulgaris","Thalassiosira_pseudonana"))


species.labs <- c("Fragilariopsis cylindrus", "Thalassiosira pseudonana","︎Chlamydomonas ICEMDV", "Chlamydomonas malina", "︎Chlamydomonas priscuii", "Chlamydomonas reinhardtii", "Chlorella vulgaris")
...
sstate_damping %>% 
  ...
  facet_wrap(vars(Species), ncol=3, scales = "free", labeller = labeller(Species=species.labs)) + 
  labs(x= "Temperature (°C)", y= "Frequency of Photon Delivery (s)", fill= "Damping Index") +
  theme_linedraw() +
  theme(text = element_text(family = "Palatino")) +
  theme(strip.text = element_text(face = "italic")) +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) 

   ggsave("heatmap.png", width = 12.22, height = 7.51, dpi = 400,
          plot=last_plot(),
         path="~/LowLightPhotosynth/Docs/ScienceAtlantic")
```
