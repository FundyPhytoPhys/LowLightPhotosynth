...
species.labs <- c("Chlamydomonas ICEMDV", "Chlamydomonas malina", "Chlamydomonas priscuii", "Chlamydomonas reinhardtii", "Chlorella vulgaris", "Fragilariopsis cylindrus")
names(species.labs) <- c("Chlamydomonas_ICEMDV", "Chlamydomonas_malina", "Chlamydomonas_priscuii", "Chlamydomonas_reinhardtii", "Chlorella_vulgaris", "Fragilariopsis_cylindrus")
```
...
sstate_damping %>% 
  filter(DampingIndex < 32) %>% 
  ggplot() + 
  geom_point(aes(x = PulseSpace_s, y = DampingIndex, colour = Temp_C, size = Temp_C)) +
