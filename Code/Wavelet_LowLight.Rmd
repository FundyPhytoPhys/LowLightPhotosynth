...
png(filename = "../Output/AvPw_WT_LOW_Takuvik_SolFits_4s_10C.png")
wt.avg(WVT_10C_4s, show.siglvl = TRUE, siglvl =  0.05,maximum.level = 1,   #set level to mark significance
periodlab = "Periodicity",
main = "Takuvik_ 10C, Pulse space 4 sec") #change to actual Taxa once data is sorted 
dev.off()

#y axis is log2 scale not linear
png(filename = "../Output/WT_LOW_Takuvik_SolFits_4s_10C.png")
...
main = "Takuvik_ 10C, Pulse space 4 sec")
dev.off()
...
#sequential lines act like they are piped; need to run as a unit
png(filename = "../Output/AvPw_WT_LOW_Takuvik_SolFits_2s_10C.png")
wt.avg(WVT_10C_2s, show.siglvl = TRUE, siglvl =  0.05, maximum.level = 1,   #set level to mark significance
periodlab = "Periodicity",
main = "Takvik 10C, Pulse space 2 sec")
dev.off()

#y axis is log2 scale not linear
png(filename = "../Output/WT_LOW_Takuvik_SolFits_2s_10C.png")
...
maximum.level = 1.001 * MP_DeSpBl,
show.date = TRUE, date.format = "%F %S",
main = "Takuvik 10C, Pulse space 2 sec")
dev.off()
...
png(filename = "../Output/AvPw_WT_LOW_Takuvik_SolFits_2s_2C.png")
wt.avg(WVT_2C_2s, show.siglvl = TRUE, siglvl =  0.05,maximum.level = 1, 
periodlab = "Periodicity",
main = "Takuvik 2C, Pulse space 2 sec")
dev.off()


png(filename = "../Output/WT_LOW_Takuvik_SolFits_2s_2C.png")
...
LOW_SolFits_4s_2C <- LOW_SolFits %>%
  filter(Temp_C == "2",
         PulseSpace_s == 4)

WVT_2C_4s <- analyze.wavelet(LOW_SolFits_4s_2C, "FvFm",
                        method = "white.noise",
                        loess.span = 0, 
                        dt = 1, dj = 1/500,
                        lowerPeriod = 2, upperPeriod = 36,
...
MP_DeSpBl <- max(WVT_2C_4s$Power)

png(filename = "../Output/AvPw_WT_LOW_Takuvik_SolFits_4s_2C.png")
wt.avg(WVT_2C_4s, show.siglvl = TRUE, siglvl =  0.05,maximum.level = 1, 
periodlab = "Periodicity",
main = "Takuvik 2C, Pulse space 4 sec")
dev.off()


png(filename = "../Output/WT_LOW_Takuvik_SolFits_4s_2C.png")
wt.image(WVT_2C_4s, periodlab = "Periodicity",
legend.params = list(lab = "wavelet power levels"),
label.time.axis = TRUE,
plot.legend = TRUE, plot.contour = TRUE,
maximum.level = 1.001 * MP_DeSpBl,
...
#sequential lines act like they are piped; need to run as a unit
png(filename = "../Output/AvPw_WT_LOW_Takuvik_SolFits_1s_10C.png")
wt.avg(WVT_10C_1s, show.siglvl = TRUE, siglvl =  0.05,maximum.level = 1,   #set level to mark significance
periodlab = "Periodicity",
main = "Takuvik 10C, Pulse space 1 sec")
dev.off()

#y axis is log2 scale not linear
png(filename = "../Output/WT_LOW_Takuvik_SolFits_1s_10C.png")
...
png(filename = "../Output/AvPw_WT_LOW_Takuvik_SolFits_1s_2C.png")
wt.avg(WVT_2C_1s, show.siglvl = TRUE, siglvl =  0.05,maximum.level = 1, 
periodlab = "Periodicity",
main = "Takuvik 2C, Pulse space 1 sec")
dev.off()


png(filename = "../Output/WT_LOW_Takuvik_SolFits_1s_2C.png")
...
reconstruct(WVT_10C_4s, siglvl = 0.05)
reconstruct(WVT_2C_1s, siglvl = 0.05)
reconstruct(WVT_2C_4s, siglvl = 0.05)
```
