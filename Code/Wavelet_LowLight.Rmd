...
tiff(filename = "../Output/AvPw_WT_LOW_SolFits_05s_18C.tiff")
wt.avg(WVT_18C_05s, show.siglvl = TRUE, siglvl =  0.05,maximum.level = 1, 
periodlab = "Pulse space 0.5 sec")
dev.off()


tiff(filename = "../Output/WT_LOW_SolFits_05s_18C.tiff")
wt.image(WVT_18C_05s, periodlab = "Pulse space 0.5 sec",
legend.params = list(lab = "wavelet power levels"),
label.time.axis = TRUE,
plot.legend = FALSE, plot.contour = FALSE,
maximum.level = 1.001 * MP_DeSpBl,
show.date = TRUE, date.format = "%F %T",
main = "Diatoms 18C, 0.5 sec")
dev.off()
