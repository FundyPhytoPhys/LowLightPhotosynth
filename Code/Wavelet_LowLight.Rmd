...
siglvl_reconstruct <- 0.1 #specifies significance level for reconstructed wave 
...
Fcdata <- summaryBy(FvFmrunnorm ~ Temp_C + PulseSpace_s + Flashnumber2, data=SolFitsFc, FUN=c(mean)) %>% 
