...
Cv_damping$PulseSpace_s <- factor(Cv_damping$PulseSpace_s, levels = c("1", "2", "4", "8", "16"))
Cv_damping$Temp_C <- factor(Cv_damping$Temp_C, levels= c("10","14","18", "22", "26"))
```
...
ggsave("heatmap.png", width = 9.0, height = 7.4, dpi = 900,
        plot=last_plot(),
