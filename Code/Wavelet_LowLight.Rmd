...
#function idea: 
  #lapply(wavelet_list, function {that extracts power.avg, power.avg.pval, period & puts into a df}
  #generates a new list with those dfs 
  #then add column in each df corresponding to condition 
  #seperate condition into temp & pulsespace)
  #then bind all elements of list into one df 
  #then ggplot with facet_grid(rows=vars(temp), cols=vars(spacing))
