...
png(filename = "../Output/AvPw_WT_LOW_Fragilariopsis_SolFits_8s_10C.png")
wt.avg(WVT_10C_8s, show.siglvl = TRUE, siglvl =  0.05,maximum.level = 1,   #set level to mark significance
periodlab = "Periodicity",
main = "Fragilariopsis_ 10C, Pulse space 8 sec") #change to actual Taxa once data is sorted 
dev.off()

#y axis is log2 scale not linear
png(filename = "../Output/WT_LOW_Fragilariopsis_SolFits_8s_10C.png")
...
main = "Fragilariopsis_ 10C, Pulse space 8 sec")
dev.off()
...
#sequential lines act like they are piped; need to run as a unit
png(filename = "../Output/AvPw_WT_LOW_Fragilariopsis_SolFits_2s_10C.png")
wt.avg(WVT_10C_2s, show.siglvl = TRUE, siglvl =  0.05, maximum.level = 1,   #set level to mark significance
periodlab = "Periodicity",
main = "Fragilariopsis 10C, Pulse space 2 sec")
dev.off()

#y axis is log2 scale not linear
png(filename = "../Output/WT_LOW_Fragilariopsis_SolFits_2s_10C.png")
