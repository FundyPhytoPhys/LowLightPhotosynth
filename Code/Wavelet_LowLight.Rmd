...
### Ci 
Possibly wonky: Chlamy/20230918_MaPo1002_8C_16s, Chlamy/20230919_MaPo1002_4C_16s, Chlamy/20230919_MaPo1002_8C_16s

```{r cleaning up Ci trials}
SolFitsCi <- SolFitsCi %>%
  filter(!Filename %in% c("Chlamy/20230918_MaPo1002_8C_16s", "Chlamy/20230919_MaPo1002_4C_16s"))
...
### Cm 
Possibly wonky: Chlamy/20230919_MaPo1003_8C_16s, Chlamy/20230919_MaPo1003_4C_16s, Chlamy/20230918_MaPo1003_8C_16s

```{r cleaning up Cm trials}
SolFitsCm <- SolFitsCm %>%
  filter(!Filename %in% c("Chlamy/20230919_MaPo1003_8C_16s", "Chlamy/20230919_MaPo1003_4C_16s", "Chlamy/20230918_MaPo1003_8C_16s"))
```
...
### Cp 
Possibly wonky: Chlamy/20230918_MaPo1001_12C_16s, Chlamy/20230919_MaPo1001_8C_16s

```{r cleaning up Cp trials}
SolFitsCp <- SolFitsCp %>%
  filter(!Filename %in% c("Chlamy/20230918_MaPo1001_12C_16s", "Chlamy/20230919_MaPo1001_8C_16s", "Chlamy/20230919_MaPo1001_4C_16s")) #deal with later
```
...
Cpdata_l <- list(
  ...
  (Cpdata %>% filter(Temp_C == "4", PulseSpace_s == 16)),
...
```{r merge}
damping_l <- list(Fc_damping, Ci_damping, Cm_damping, Cp_damping, Cr_damping)

sstate_damping <- damping_l %>% reduce(full_join)
