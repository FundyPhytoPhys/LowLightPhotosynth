...
WVT_10C_2s <- analyze.wavelet(LOW_SolFits_2s_10C, "FvFm",
                        method = "white.noise",
                        loess.span = 0, 
                        dt = 1, dj = 1/500,
                        lowerPeriod = 2, upperPeriod = 36,
...
#sequential lines act like they are piped; need to run as a unit
png(filename = "../Output/AvPw_WT_LOW_SolFits_2s_10C.png")
wt.avg(WVT_10C_2s, show.siglvl = TRUE, siglvl =  0.05, maximum.level = 1,   #set level to mark significance
periodlab = "Periodicity",
main = "Diatoms 10C, Pulse space 2 sec")
dev.off()

#y axis is log2 scale not linear
png(filename = "../Output/WT_LOW_SolFits_2s_10C.png")
...
png(filename = "../Output/AvPw_WT_LOW_SolFits_2s_18C.png")
wt.avg(WVT_18C_2s, show.siglvl = TRUE, siglvl =  0.05,maximum.level = 1, 
periodlab = "Periodicity",
main = "Diatoms 18C, Pulse space 2 sec")
dev.off()


png(filename = "../Output/WT_LOW_SolFits_2s_18C.png")
...
png(filename = "../Output/AvPw_WT_LOW_SolFits_4s_18C.png")
wt.avg(WVT_18C_4s, show.siglvl = TRUE, siglvl =  0.05,maximum.level = 1, 
periodlab = "Periodicity",
main = "Diatoms 18C, Pulse space 4 sec")
dev.off()


png(filename = "../Output/WT_LOW_SolFits_4s_18C.png")
