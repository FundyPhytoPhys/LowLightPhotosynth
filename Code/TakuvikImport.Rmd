...
```{r correct prefaces}
SolFitsTrim <- SolFits #create tidy df 
...
SolFitsTrim <- rbind(SolFitsBadNames, SolFitsGoodNames) #merge
```
...
SolFitsFragilariopsis %>%
  ...
  ggplot() +
  geom_line(aes(x=Flashnumber2, y=FvFmrunnorm)) +
  #facet_wrap(vars(CultureID)) +
