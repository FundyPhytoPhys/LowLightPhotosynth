...
SolFitsMeta |>
  ...
  ggplot() +
  geom_point(aes(x = Flashnumber, y = FvFmrunnorm, )) +
  facet_grid(rows = vars(Temp_C, NaCl_mM), cols = vars(Strain)) +
  theme_bw()
...
SolFitsMeta |>
  ...
  ggplot() +
  geom_point(aes(x = Flashnumber, y = FvFmrunnorm, )) +
  facet_grid(rows = vars(GrowthTemp_C,Temp_C), cols = vars(Strain, NaCl_mM)) +
  theme_bw()
