...
DataIn <- file.path("..","Data", "RawData", TargetTaxa, "NoDecay", fsep = .Platform$file.sep)
DataRefDecay <- file.path("..","Data", "RawData",TargetTaxa, "RefDecay", fsep = .Platform$file.sep)
...
SolFitsTrim %>%
  ggplot()+
  geom_line(aes(x=Flashnumber, y=Fmrunnorm, colour = as.factor(PulseSpace_s))) +
